...
class constants:
    ...
    gov_service_description_1 = (
        ...
        "counties you have selected. Each county will follow up with you with "
        "next steps. For example, if you apply in San Francisco and Contra "
        "Costa County, you will hear from both San Francisco Public Defender "
        "and Contra Costa Public Defender separately.")

    journey_headline = "Apply to Clear My Record in 3 easy steps:"
    step_1_headline = "1. Apply online"
    step_1_paragraph = ("Fill out the pre-screener to help "
                        "the attorney understand your history.")
    step_2_headline = "2. Check your eligibility"
    step_2_paragraph = ("An attorney will pull up your conviction records and "
                        "figure out what record clearance options make sense "
                        "for you.")
    ...
    time_expectation = ("It could take up to one year to clear your record. "
                        "Start today.")

    returning_user_question = "Already applied to Clear My Record?"
    returning_user_headline = \
        "Get in touch with the San Francisco public defender"
    returning_user_help_paragraph = (
        "Have questions about your pending application? "
        "Call the San Francisco Public Defender’s "
    ...
    opportunity_2 = ("Improve your chances of qualifying for financial aid "
                     "or housing assistance")
    opportunity_3 = "Hold a record that better represents who you are today"

    footer_website_description = "Code for America"
    footer_legal = "Privacy Policy"

    footer_sf = "San Francisco Public Defender"
    footer_cc = "Contra Costa Public Defender"
    footer_alameda = "Alameda County Public Defender's Office"
    footer_ebclc = "East Bay Community Law Center"
    footer_monterey = "Monterey County Public Defender"
    footer_solano = "Solano County Public Defender"
    footer_san_diego = "San Diego County Public Defender"
    footer_san_joaquin = "San Joaquin County Public Defender"
    footer_santa_clara = "Santa Clara County Public Defender"
    footer_fresno = "Fresno County Public Defender"

    back_home_btn = "Go back to main page"

    metadata_title = topbar
    metadata_description = ("Clear My Record is a free, non-profit service to "
                            "help you dismiss or reduce old convictions on "
